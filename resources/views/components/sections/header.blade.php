{{-- <header class="fixed left-0 top-0 z-50 w-full"
	:class="{ 'shadow-lg bg-indigo-900': menuIsOpen, 'bg-indigo-800': !menuIsOpen }"
	x-data="{ menuIsOpen: false }"
	@keydown.escape ="menuIsOpen=false"
	@click.away="menuIsOpen = false">
	<div class="container flex flex-wrap items-center justify-between"
		class="mr-6 flex flex-shrink-0 items-center text-white"
		<div>
		...
		<button class="flex items-center focus:outline-none md:hidden"
			x-on:click="menuIsOpen = !menuIsOpen">
			<div class="w-8 flex items-center justify-center relative">
				<span class="transform transition w-full h-px bg-white absolute"
					x-bind:class="menuIsOpen ? 'translate-y-0 rotate-45' : '-translate-y-2'">
				</span>

				<span class="transform transition w-full h-px bg-white absolute"
					x-bind:class="menuIsOpen ? 'opacity-0 translate-x-3' : 'opacity-100'">
				</span>
...
<header class="fixed inset-x-0 z-50 w-full py-6"
	id="header">
	<div class="container flex min-h-[60px] items-center justify-between max-[768px]:py-3 md:min-h-[2.5rem]">
		<div class="relative z-50 flex-shrink-0">
			{{-- <a class=""
				href="/">
				<img src="{{ Vite::asset('resources/assets/images/logos/logo-main.svg') }}"
					alt="logo"
					width="80"
					height="32" />
			</a> --}}
			<a class="group/filament gsap-fadein relative"
				href="/"
				style="translate: none; rotate: none; scale: none; transform: translate(0px, 0px); opacity: 1; visibility: inherit;">
				<div class="text-black">
					<svg class="h-auto w-24 overflow-visible min-[400px]:w-28 md:w-36"
						fill="currentColor"
						viewBox="0 0 128 26">
					...
					<div
						...
						<svg class="scale-[.65] min-[400px]:scale-75 md:scale-100"
							width="37"
							height="52"
							fill="none"
							xmlns="http://www.w3.org/2000/svg">
							<circle class="text-yellow-400"
								cx="18.697"
								cy="17.903"
								r="12.731"
		...
		<nav class="hidden md:block">
			<ul class="flex flex-wrap items-center gap-x-[10px] gap-y-4 lg:gap-x-[20px] xl:gap-x-[30px]">
				<li>
					<a class="navbar__link _after"
						href="/">{{ __('Home') }}</a>
				</li>
				<li>
					<a class="navbar__link _after"
		...
		{{-- <nav class="navbar transition-left left-[-100%] duration-300 md:hidden"
			...
			<ul class="container flex flex-col gap-y-4"
				x-data="{ selectedSubMenu: null }">
				<li class="flex flex-wrap items-center justify-between"
					@click="selectedSubMenu !== 'main' ? selectedSubMenu = 'main' : selectedSubMenu = null">
					<a class="navbar__link _after"
						href="{{ route('page.show-home') }}"
						:class="{ '_active': selectedSubMenu === 'main' }"
						@click.stop>
						{{ __('Головна') }}
					</a>
					...
					<button class="transition-transform duration-300"
						type="button"
						:class="{ 'rotate-180': selectedSubMenu === 'main' }">
						<svg class="fill-current transition-colors duration-300"
							width="11"
							height="7"
							viewBox="0 0 11 7"
							xmlns="http://www.w3.org/2000/svg"
							:class="selectedSubMenu === 'main' && '!fill-red'">
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M0.665522 0.628357C0.870777 0.443628 1.18692 0.460267 1.37165 0.665522L5.5 5.25258L9.62836 0.665522C9.81309 0.460267 10.1292 0.443628 10.3345 0.628357C10.5397 0.813087 10.5564 1.12923 10.3717 1.33449L5.87165 6.33449C5.77683 6.43984 5.64175 6.5 5.5 6.5C5.35826 6.5 5.22318 6.43984 5.12836 6.33449L0.628357 1.33449C0.443628 1.12923 0.460267 0.813087 0.665522 0.628357Z" />
						</svg>
					</button>
					<div class="basis-full"
						x-show="selectedSubMenu === 'main'"
						x-collapse>
						<ul class="grid gap-y-[6px] pl-4 pt-4 text-sm text-white">
							<li class=""><a href="#">{{ __('Контакти') }}</a></li>
						</ul>
					</div>
				</li>

				<li class="flex flex-wrap items-center justify-between"
					@click="selectedSubMenu !== 'shop' ? selectedSubMenu = 'shop' : selectedSubMenu = null">
					<a class="navbar__link _after"
						href="#"
						:class="{ '_active': selectedSubMenu === 'shop' }"
						@click.stop>
						{{ __('Магазин') }}
					</a>
					...
					<button class="transition-transform duration-300"
						type="button"
						:class="{ 'rotate-180': selectedSubMenu === 'shop' }">
						<svg class="fill-current transition-colors duration-300"
							width="11"
							height="7"
							viewBox="0 0 11 7"
							xmlns="http://www.w3.org/2000/svg"
							:class="selectedSubMenu === 'shop' && '!fill-red'">
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M0.665522 0.628357C0.870777 0.443628 1.18692 0.460267 1.37165 0.665522L5.5 5.25258L9.62836 0.665522C9.81309 0.460267 10.1292 0.443628 10.3345 0.628357C10.5397 0.813087 10.5564 1.12923 10.3717 1.33449L5.87165 6.33449C5.77683 6.43984 5.64175 6.5 5.5 6.5C5.35826 6.5 5.22318 6.43984 5.12836 6.33449L0.628357 1.33449C0.443628 1.12923 0.460267 0.813087 0.665522 0.628357Z" />
						</svg>
				...
				<li class="flex flex-wrap items-center justify-between"
					@click="selectedSubMenu !== 'data-center' ? selectedSubMenu = 'data-center' : selectedSubMenu = null">
					<a class="navbar__link _after"
						href="#"
						:class="{ '_active': selectedSubMenu === 'data-center' }"
						@click.stop>
						{{ __('Дата-центр') }}
					</a>
					...
					<button class="transition-transform duration-300"
						type="button"
						:class="{ 'rotate-180': selectedSubMenu === 'data-center' }">
						<svg class="fill-current transition-colors duration-300"
							width="11"
							height="7"
							viewBox="0 0 11 7"
							xmlns="http://www.w3.org/2000/svg"
							:class="selectedSubMenu === 'data-center' && '!fill-red'">
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M0.665522 0.628357C0.870777 0.443628 1.18692 0.460267 1.37165 0.665522L5.5 5.25258L9.62836 0.665522C9.81309 0.460267 10.1292 0.443628 10.3345 0.628357C10.5397 0.813087 10.5564 1.12923 10.3717 1.33449L5.87165 6.33449C5.77683 6.43984 5.64175 6.5 5.5 6.5C5.35826 6.5 5.22318 6.43984 5.12836 6.33449L0.628357 1.33449C0.443628 1.12923 0.460267 0.813087 0.665522 0.628357Z" />
						</svg>
					...
					<div class="basis-full"
						x-show="selectedSubMenu === 'data-center'"
						x-collapse>
						<ul class="grid gap-y-[6px] pl-4 pt-4 text-sm text-white">
							<li class=""><a href="#">#</a></li>
							<li><a href="#">#</a></li>
				...
				<li class="flex flex-wrap items-center justify-between"
					@click="selectedSubMenu !== 'service-center' ? selectedSubMenu = 'service-center' : selectedSubMenu = null">
					<a class="navbar__link _after @if (\Request::routeIs('page.service-center')) _active @endif"
						href="#"
						@click.stop>
						{{ __('Сервіс-центр') }}
					</a>

					<button class="transition-transform duration-300 @if (\Request::routeIs('page.service-center')) rotate-180 @endif"
						type="button">
						<svg
							class="fill-current transition-colors duration-300 rotate-180 @if (\Request::routeIs('page.service-center')) !fill-red @endif"
							width="11"
							height="7"
							viewBox="0 0 11 7"
							xmlns="http://www.w3.org/2000/svg">
					...
					<div class="basis-full"
						x-show="selectedSubMenu === 'service-center'"
						x-collapse>
						<ul class="grid gap-y-[6px] pl-4 pt-4 text-sm text-white">
							<li class=""><a href="#">{{ __('Заявки') }}</a></li>
							<li><a href="{{ route('page.conditions') }}">{{ __('Умови') }}</a></li>
						</ul>
					</div>
				</li>

				<li class="flex flex-wrap items-center justify-between"
					@click="selectedSubMenu !== 'trading' ? selectedSubMenu = 'trading' : selectedSubMenu = null">
					<a class="navbar__link _after"
						href="#"
						:class="{ '_active': selectedSubMenu === 'trading' }"
						@click.stop>
						{{ __('Криптотрейдинг') }}
					</a>
					...
					<button class="transition-transform duration-300"
						type="button"
						:class="{ 'rotate-180': selectedSubMenu === 'trading' }">
						<svg class="fill-current transition-colors duration-300"
							width="11"
							height="7"
							viewBox="0 0 11 7"
							xmlns="http://www.w3.org/2000/svg"
							:class="selectedSubMenu === 'trading' && '!fill-red'">
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M0.665522 0.628357C0.870777 0.443628 1.18692 0.460267 1.37165 0.665522L5.5 5.25258L9.62836 0.665522C9.81309 0.460267 10.1292 0.443628 10.3345 0.628357C10.5397 0.813087 10.5564 1.12923 10.3717 1.33449L5.87165 6.33449C5.77683 6.43984 5.64175 6.5 5.5 6.5C5.35826 6.5 5.22318 6.43984 5.12836 6.33449L0.628357 1.33449C0.443628 1.12923 0.460267 0.813087 0.665522 0.628357Z" />
						</svg>
					...
					<div class="basis-full"
						x-show="selectedSubMenu === 'trading'"
						x-collapse>
						<ul class="grid gap-y-[6px] pl-4 pt-4 text-sm text-white">
							<li class=""><a href="#">#</a></li>
							<li><a href="#">#</a></li>
				...
				<li>
					<button class="flex w-full items-center gap-x-3 text-sm text-white"
						type="button"
						@click="activePopup = '#login-popup' , menuIsOpen = false">
						<svg width="18"
							height="20"
							viewBox="0 0 18 20"
							fill="none"
							...
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M6.7446 3.65805C5.50511 4.89754 5.50511 6.90715 6.7446 8.14664C7.98409 9.38613 9.9937 9.38613 11.2332 8.14664C12.4727 6.90715 12.4727 4.89754 11.2332 3.65805C9.9937 2.41856 7.98409 2.41856 6.7446 3.65805ZM5.33038 9.56085C3.30985 7.54031 3.30985 4.26437 5.33038 2.24383C7.35092 0.223295 10.6269 0.223295 12.6474 2.24383C14.6679 4.26437 14.6679 7.54031 12.6474 9.56085C10.6269 11.5814 7.35092 11.5814 5.33038 9.56085Z"
								fill="white" />
							<path fill-rule="evenodd"
								clip-rule="evenodd"
								d="M3.91421 15.1951C2.6503 16.0743 2 17.1913 2 18.3094C2 18.8616 1.55228 19.3094 1 19.3094C0.447715 19.3094 0 18.8616 0 18.3094C0 16.3539 1.14056 14.6882 2.77208 13.5533C4.40718 12.4158 6.61218 11.7441 9 11.7441C11.3878 11.7441 13.5928 12.4158 15.2279 13.5533C16.8594 14.6882 18 16.3539 18 18.3094C18 18.8616 17.5523 19.3094 17 19.3094C16.4477 19.3094 16 18.8616 16 18.3094C16 17.1913 15.3497 16.0743 14.0858 15.1951C12.8255 14.3183 11.0305 13.7441 9 13.7441C6.96955 13.7441 5.17454 14.3183 3.91421 15.1951Z"
								fill="white" />
						</svg>
